...
const MainFeed = () => {
  ...
  // Combine user posts with static activities
          ...
          <div>
            ...
            <div className="flex items-center justify-between mt-2 sm:mt-3 pt-2 sm:pt-3 border-t border-gray-100 dark:border-gray-700">
              ...
              <button 
                ...
                className="flex items-center gap-1 sm:gap-1.5 text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 hover:text-prieska-terracotta transition px-2 sm:px-3 py-1 sm:py-1.5 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700"
              >
      ...
      {postedActivities.map(activity => (
        <div key={activity.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
          ...
          <div className="px-2.5 sm:px-4 pb-2 sm:pb-3">
            ...
            {activity.description && <p className="text-gray-600 dark:text-gray-300 text-[10px] sm:text-xs leading-relaxed">{activity.description}</p>}
          </div>

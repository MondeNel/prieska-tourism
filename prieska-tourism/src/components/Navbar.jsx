        ...
        <div className="container mx-auto px-4 sm:px-6 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="hidden md:flex space-x-8">
              ...
              <a href="#accommodation" className={`transition font-medium duration-300 ${isScrolled ? 'text-[#3D2B1A] hover:text-[#B87333]' : 'text-white hover:text-[#E6B17E]'}`}>
                Accommodation
              </a>
            ...
            <button 
              ...
              className={`hidden md:block font-semibold px-6 py-2 rounded-full transition-all duration-300 shadow-lg ${
                isScrolled 

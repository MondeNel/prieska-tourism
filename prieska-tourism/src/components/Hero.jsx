          ...
          <div className="max-w-3xl text-white">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <button 
                ...
                className="bg-white/20 backdrop-blur-sm border border-white/40 hover:bg-white/30 text-white font-medium px-6 py-3 rounded-full transition-all duration-300 inline-flex items-center"
              >

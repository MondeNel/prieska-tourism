...
const Attractions = () => {
  return (
    <section id="discover" className="py-16 px-4 max-w-7xl mx-auto bg-prieska-sand/20 dark:bg-gray-900">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {attractions.map((attr) => (
          <div key={attr.id} className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-md hover:shadow-xl transition group">
            ...
            <div className="p-6">
              <h3 className="text-xl font-serif font-bold mb-2 text-gray-800 dark:text-white">{attr.name}</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">{attr.description}</p>
              <div className="flex items-center text-prieska-terracotta dark:text-prieska-terracotta font-medium">
